...
//for product profile
  ...
  $expiration_date = date_create($_POST['expiration']);
...
//
    $product = "INSERT INTO prod_profile(name, expiration_date,supplier,category)VALUES('$item','$expiration_date','$supplier','Medicine')";
    $db->query($product);
