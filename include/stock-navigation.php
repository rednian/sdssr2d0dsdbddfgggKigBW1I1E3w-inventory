      ...
      <ul class="nav navbar-nav">
        <li class="dropdown user user-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <img src="<?php if($row['image'] == ''){ echo '../dist/img/user2-160x160.jpg';}else{ echo '../image_upload/'.$row['image'];}?>" class="user-image" alt="User Image"/>
            <span class="hidden-xs"><?php echo $row['firstname']." ".$row['lastname']; ?><span class="caret"></span></span>
          </a>
          <ul class="dropdown-menu">
            <li class="user-header">
              <img src="<?php if($row['image'] == ''){ echo '../dist/img/user2-160x160.jpg';}else{ echo '../image_upload/'.$row['image'];}?>" class="img-circle" alt="User Image"/>
