...
<aside class="main-sidebar hidden-print">
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li><a href="index.php"><i class='fa fa-shopping-cart'></i> <span>Stock-out</span></a></li>
      <li <?php if($file == 'item'){ echo "class='active'";}?>><a href="stock-in/add-item.php"><i class='fa fa-shopping-cart'></i>
